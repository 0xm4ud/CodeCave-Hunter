...
if len(sys.argv) == 3:
    ...
    print("========================================================\r\n")
    output2 = pykd.dbgCommand(f"r $t0 = poi({module_name}+poi({module_name}+0x3c)+0xd8)")
    output2 = pykd.dbgCommand(f"r $t1 = poi({module_name}+poi({module_name}+0x3c)+0xdc)")
    output2 = pykd.dbgCommand(f"dps {module_name}+$t0 l? (($t1+4)/4)")
